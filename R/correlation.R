...
infection_data <- infection_data$infections_north
# infection_data <- infection_data$infections_maastricht
# infection_data <- infection_data$infections_utrecht
# infection_data <- infection_data$infections_nijmegen
# infection_data <- infection_data$infections_rotterdam

# Linear regression - by age and at the province level -------------------------

df_contact <- contact_data$age
df_contact <- left_join(df, infection_data$infection_age,
                by = c("date", "age_g"),
